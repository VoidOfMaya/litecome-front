...
const UserIcon =({fn, color ='#27282c', focusColor='#62646b', size=25})=>{
...
const SendIcon = ({fn, color ='#27282c', focusColor='#62646b', size=25})=>{
    const [focuse, setFocus]= useState(false);
    return(
        <svg xmlns="http://www.w3.org/2000/svg" 
            height={`${size}px`} 
...
const SearchIcon = ({fn, color ='#27282c', focusColor='#62646b', size=25})=>{
    const [focuse, setFocus]= useState(false);
    return(
        <svg xmlns="http://www.w3.org/2000/svg" 
            height={`${size}px`} 
...
const FriendsIcon = ({fn, color ='#27282c', focusColor='#62646b', size=25})=>{
    const [focuse, setFocus]= useState(false);
    return(
        <svg xmlns="http://www.w3.org/2000/svg" 
            height={`${size}px`} 
...
const GroupIcon = ({fn, color ='#27282c', focusColor='#62646b', size=25})=>{
    const [focuse, setFocus]= useState(false);
    return(
        <svg xmlns="http://www.w3.org/2000/svg" 
            height={`${size}px`} 
...
const ReplyIcon = ({fn, color, focusColor, width, height})=>{
    const [focuse, setFocus]= useState(false);
    return(
...
const LeftArrow = ({fn, color ='#27282c', focusColor='#62646b', size=25})=>{
    const [focuse, setFocus]= useState(false);
    return(
        <svg xmlns="http://www.w3.org/2000/svg" 
            height={`${size}px`}  
...
const RightArrow = ({fn, color ='#27282c', focusColor='#62646b', size=25})=>{
    const [focuse, setFocus]= useState(false);
    return(
        <svg xmlns="http://www.w3.org/2000/svg" 
            height={`${size}px`}  
